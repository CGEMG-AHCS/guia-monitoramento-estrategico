...
Orientações sobre a metodologia de monitoramento estratégico, incluindo procedimentos de coleta, consolidação, tratamento e análise das informações utilizadas para acompanhar a atuação das Controladorias Setoriais e Seccionais.

### Bases de Dados

Informações sobre as principais fontes de dados utilizadas no monitoramento, suas finalidades, formas de acesso e orientações para utilização.

### Sistema de Auditoria – e-CGU

Manual prático para consulta e utilização das informações registradas no sistema de auditoria e-CGU, bem como orientações relacionadas às atividades de monitoramento.
...
>
> O conteúdo será atualizado continuamente pela AHCS, com a inclusão de novas orientações, bases de dados, metodologias, indicadores e materiais de apoio destinados ao aperfeiçoamento do monitoramento estratégico das Controladorias Setoriais e Seccionais.
