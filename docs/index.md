...
Descrição das principais bases de dados utilizadas no monitoramento estratégico, incluindo suas finalidades, formas de acesso, informações disponíveis, periodicidade de atualização, exemplos de utilização e possibilidades de aplicação nas análises.
...
>
> O conteúdo será atualizado continuamente pela AHCS, incorporando novas metodologias, bases de dados, indicadores, análises, materiais de apoio e orientações destinadas ao aperfeiçoamento do monitoramento estratégico das Controladorias Setoriais e Seccionais.
